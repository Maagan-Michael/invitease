...
./kcadm.sh create clients -s clientId=invitease -s 'redirectUris=["http://invitease.localhost/*"]' -s clientAuthenticatorType=client-secret -s serviceAccountsEnabled=true -s secret=d0b8122f-8dfb-46b7-b68a-f5cc4e25d000
